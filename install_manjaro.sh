...
sudo pacman -S protobuf python-pip git

sudo pip uninstall numpy
sudo pacman -Syu base-devel opencv opencv-samples python-matplotlib
sudo pacman -S hdf5
sudo pacman -S protobuf python-pip git python-pillow
